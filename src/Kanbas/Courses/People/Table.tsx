...
<thead>
<tr>
<th>Name</th><th>Login ID</th><th>Section</th><th>Role</th><th>Email</th><th>Last Activity</th><th>Total Activity</th>
</tr>
</thead>
<tbody>
{users.map((user: any) => (
...
<td>{user.loginId}</td><td>{user.section}</td><td>{user.role}</td><td>{user.email}</td><td>{user.lastActivity}</td>
